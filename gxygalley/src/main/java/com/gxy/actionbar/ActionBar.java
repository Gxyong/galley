...
import com.gxy.Theme;
import com.gxy.proxy.AnimatorListenerAdapterProxy;
import com.gxy.utils.AndroidUtilities;
import com.gxy.utils.Gallery;
import com.gxy.utils.LayoutHelper;
...
public class ActionBar extends FrameLayout {
    ...
    private com.gxy.actionbar.SimpleTextView titleTextView;
    private com.gxy.actionbar.SimpleTextView subtitleTextView;
    private View actionModeTop;
    private com.gxy.actionbar.ActionBarMenu menu;
    private com.gxy.actionbar.ActionBarMenu actionMode;
    ...
    protected com.gxy.actionbar.BaseFragment parentFragment;
    ...
    public void setBackButtonDrawable(Drawable drawable) {
        ...
        if (drawable instanceof com.gxy.actionbar.BackDrawable) {
            ((com.gxy.actionbar.BackDrawable) drawable).setRotation(isActionModeShowed() ? 1 : 0, false);
        }
    }
    ...
    private void createsubtitleTextView() {
        ...
        subtitleTextView = new com.gxy.actionbar.SimpleTextView(getContext());
    ...
    private void createTitleTextView() {
        ...
        titleTextView = new com.gxy.actionbar.SimpleTextView(getContext());
...
//        titleTextView.getPaint().setFakeBoldText(true);
    ...
    public com.gxy.actionbar.SimpleTextView getSubtitleTextView() {
        return subtitleTextView;
    }

    public com.gxy.actionbar.SimpleTextView getTitleTextView() {
    ...
    public com.gxy.actionbar.ActionBarMenu createMenu() {
        if (menu != null) {
            return menu;
        }
        screenSize = AndroidUtilities.getRealScreenSize();
        menu = new com.gxy.actionbar.ActionBarMenu(getContext(), this);
    ...
    public com.gxy.actionbar.ActionBarMenu createActionMode() {
        if (actionMode != null) {
            return actionMode;
        }
        actionMode = new com.gxy.actionbar.ActionBarMenu(getContext(), this);
    ...
    public void showActionMode() {
        ...
        if (backButtonImageView != null) {
            ...
            if (drawable instanceof com.gxy.actionbar.BackDrawable) {
                ((com.gxy.actionbar.BackDrawable) drawable).setRotation(1, true);
            }
    ...
    public void hideActionMode() {
        ...
        if (backButtonImageView != null) {
            Drawable drawable = backButtonImageView.getDrawable();
            if (drawable instanceof com.gxy.actionbar.BackDrawable) {
                ((com.gxy.actionbar.BackDrawable) drawable).setRotation(0, true);
            }
            backButtonImageView
                    .setBackgroundDrawable(Theme.createBarSelectorDrawable(itemsBackgroundColor));
        }
    ...
    protected void onSearchFieldVisibilityChanged(boolean visible) {
        ...
        Drawable drawable = backButtonImageView.getDrawable();
        if (drawable != null && drawable instanceof com.gxy.actionbar.MenuDrawable) {
            ((com.gxy.actionbar.MenuDrawable) drawable).setRotation(visible ? 1 : 0, true);
        }
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child instanceof com.gxy.actionbar.ActionBarMenuItem){
                int realTextSize;
                int count = ((com.gxy.actionbar.ActionBarMenuItem) child).getChildCount();
                for (int j = 0; j < count; j++) {
                    if (((com.gxy.actionbar.ActionBarMenuItem) child).getChildAt(j) instanceof TextView){
                        TextView innertext = (TextView) ((com.gxy.actionbar.ActionBarMenuItem) child).getChildAt(j);
